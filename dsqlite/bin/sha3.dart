// *********************************************
// credit: https://github.com/C0MM4ND/dart_sha3
// *********************************************
...
const sha3Padding = [6, 1536, 393216, 100663296];

const finalizeError = 'finalize already called';
...
class SHA3 {
  ...
  late int blockCount;
  late int byteCount;
  late int outputBlocks;
  late int outputBits;
  late int extraBytes;
  int lastByteIndex = 0;

  SHA3(int bits, this.outputBits, [this.padding = sha3Padding]) {
  ...
  void finalize() {
    ...
    finalized = true;
    var blocks = this.blocks, i = lastByteIndex, blockCount = this.blockCount, s = this.s;
  ...
  List<int> digest() {
    ...
    var blockCount = this.blockCount,
        ...
        i = 0,
        j = 0;
    var array = List<int>.filled((outputBlocks << 2), 0); // final hash Uint8Array
    int offset, block;
...
// ************************************************
// credit: https://github.com/stevenroose/dart-hex
// ************************************************

const hex = HexEncoder(upperCase: false);
